...
namespace OpenTween
{
    ...
    class FiltersClassTest
    {
        ...
        {
            var filter = new FiltersClass { FilterName = "hogehoge" };
            var post = new PostClass { ScreenName = "hogehoge" };
        ...
        {
            var filter = new FiltersClass { ExFilterName = "hogehoge" };
            var post = new PostClass { ScreenName = "hogehoge" };
        ...
        {
            var filter = new FiltersClass { FilterName = "hogehoge", ExFilterSource = "tetete" };
        ...
        public void SourceHtmlTest(bool useRegex, string pattern, bool exclude)
        {
            ...
            // FilterName は UseRegex の値に関わらず部分一致
